...
import EditorHeader from './EditorHeader'; // Import the EditorHeader
...
const ArcodeLayout: React.FC = () => {
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-background text-foreground">
      <EditorHeader /> {/* EditorHeader is now at the top */}
      <div className="flex-grow flex overflow-hidden"> {/* Wrapper for ResizablePanelGroup to manage flexible height and overflow */}
